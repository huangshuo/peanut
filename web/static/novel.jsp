    ...
    <script>
        $(function () {
            ...
            $("#novelTypeIdPrimary").on("change", function () {
                ...
                // console.log(secondaryType.children());
                    ...
                    <div class="am-u-md-10">
                        <form id="form1" class="am-form-inline" role="form">
                            <div class="am-form-group">
                                ...
                                <input id="novelId" name="novelId" type="text" class="am-form-field am-round" placeholder="书籍ID">
                            </div>

                            <div class="am-form-group">
                                <input id="novelName" name="novelName" type="text" class="am-form-field am-round" placeholder="名称">
                            </div>
                            ...
                            <button type="button" id="search" class="am-btn am-btn-primary"><i class="am-icon-search"></i>&nbsp;&nbsp;搜索</button>
                        </form>
                    </div>
                </div>
                <div class="am-g">
