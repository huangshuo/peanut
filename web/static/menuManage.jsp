    ...
    $('#doc-prompt-toggle').on('click', function() {
      ...
      $('#my-prompt').modal({
        ...
        onConfirm: function(e) {
          ...
          //前台数据伪更新
          $(".content").children().children("td:first").next().html($("#menuName").val());
          $(".content").children().children("td:first").next().next().html($("#fid").val());
          $(".content").children().children("td:first").next().next().next().html($("#isShow").val());
          $(".content").children().children("td:first").next().next().next().next().html( $("#icon").val());
        }
      });
    })
  }
