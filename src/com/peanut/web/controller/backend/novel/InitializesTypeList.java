...
public class InitializesTypeList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<BackendNovelTypePrimary> primaryList = service.selectAllPrimaryType().getData();
		for (BackendNovelTypePrimary primary:primaryList){
			resultMap.put(primary.getTypeName() + "ID:" + primary.getTypeId(), service.selectSecondaryTypeByFatherId(primary.getTypeId()).getData());
		}
